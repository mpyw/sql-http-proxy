...
```txt
https://github.com/mpyw/sql-http-proxy/internal/config/schema.json#/$defs/mockTransformOne/oneOf/10/not
```
...
merged type ([Details](schema-defs-mocktransformone-oneof-10-not.md))
