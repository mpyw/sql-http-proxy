# Plain Object Shorthand Schema

```txt
https://github.com/mpyw/sql-http-proxy/internal/config/schema.json#/$defs/mockTransformMany/oneOf/9
```

Plain object shorthand for JSON data (e.g., { id: 1, name: 'Alice' })
...
`object` ([Plain Object Shorthand](schema-defs-mock-transform-type-many-oneof-plain-object-shorthand.md))
