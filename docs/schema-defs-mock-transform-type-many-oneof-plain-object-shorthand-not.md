...
```txt
https://github.com/mpyw/sql-http-proxy/internal/config/schema.json#/$defs/mockTransformMany/oneOf/9/not
```
...
merged type ([Details](schema-defs-mock-transform-type-many-oneof-plain-object-shorthand-not.md))
